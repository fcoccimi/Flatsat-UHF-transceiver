...
#
# Generated by export_simulation on Sun Mar 28 23:43:53 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './Clk_gen_pll.sh' script.

./Clk_gen_pll.sh -reset_run
...
./Clk_gen_pll.sh -noclean_files

For more information on the script, please type './Clk_gen_pll.sh -help'.
