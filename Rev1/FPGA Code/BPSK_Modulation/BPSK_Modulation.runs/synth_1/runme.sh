...
HD_PWD='C:/Users/franc/Documents/GitHub/ELEC-490/BPSK_Modulation/BPSK_Modulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BPSK_LMS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BPSK_LMS.tcl
