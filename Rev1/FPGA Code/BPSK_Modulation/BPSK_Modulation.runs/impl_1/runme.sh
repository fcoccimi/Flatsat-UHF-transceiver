...
HD_PWD='C:/Users/franc/Documents/GitHub/ELEC-490/BPSK_Modulation/BPSK_Modulation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BPSK_LMS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BPSK_LMS.tcl -notrace
